<?php
class Wsu_ThemeControll_Block_Adminhtml_System_Config_Form_Fieldset_Cssgen extends Mage_Adminhtml_Block_System_Config_Form_Field {
    /**
     * Generate CSS
     *
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        $url          = $this->getUrl('themecontroll/adminhtml_cssgen/' . $name, array(
            'website' => $website,
            'store' => $store
        ));
        $buttonSuffix = '';
