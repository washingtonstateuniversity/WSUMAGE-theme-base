<?php
class Wsu_ThemeControll_Block_Adminhtml_System_Config_Form_Field_Tex extends Mage_Adminhtml_Block_System_Config_Form_Field {
    /**
     * Add texture preview
     *
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        //$texPath = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . 'wysiwyg/wsu/themecontroll/patterns/default/';
        $texPath     = Mage::helper('themecontroll')->getPatternsUrl();
