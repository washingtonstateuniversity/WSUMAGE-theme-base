<?php
class Wsu_ThemeControll_Helper_Data extends Mage_Core_Helper_Abstract {
    /**
     * Patterns
     *
     * @var array
    ...
    public function __construct() {
        //Create paths
        $this->_texPath      = 'wysiwyg/wsu/themecontroll/_patterns/default/';
        $this->_bgImagesPath = 'wysiwyg/wsu/themecontroll/_backgrounds/';
    }
    ...
    public function getCfgGroup($group, $storeId = NULL) {
        if ($storeId)
            return Mage::getStoreConfig('themecontroll/' . $group, $storeId);
        else
            return Mage::getStoreConfig('themecontroll/' . $group);
    }
    /**
    ...
    public function getCfgSectionDesign($storeId = NULL) {
        if ($storeId)
            return Mage::getStoreConfig('themecontroll_design', $storeId);
        else
            return Mage::getStoreConfig('themecontroll_design');
    }
    /**
    ...
    public function getCfg($optionString) {
        return Mage::getStoreConfig('themecontroll/' . $optionString);
    }
    /**
    ...
    public function getCfgDesign($optionString, $storeCode = NULL) {
        return Mage::getStoreConfig('themecontroll_design/' . $optionString, $storeCode);
    }
    /**
    ...
    public function getCfgLayout($optionString, $storeCode = NULL) {
        return Mage::getStoreConfig('themecontroll_layout/' . $optionString, $storeCode);
    }
    /**
